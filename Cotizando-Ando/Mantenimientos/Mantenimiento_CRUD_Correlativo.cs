...
{
    public partial class Formulario_CRUD_Correlativo : Form
    {
        public Formulario_CRUD_Correlativo()
        {
            InitializeComponent();
        }

        private void Formulario_CRUD_Correlativo_Load(object sender, EventArgs e)
        {
